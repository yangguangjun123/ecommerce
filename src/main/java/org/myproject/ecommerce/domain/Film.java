...
public class Film extends Product{
    ...
    public Film(String sku, String type, String genre, String title, String description,
    ...
    public static class FilmBuilder extends ProductBuilder {
        ...
        public FilmBuilder(String sku, String type) {
            super(sku, type);
        }
        ...
        public Film build() {
            return new Film(sku, type, genre, super.title, description, asin,
