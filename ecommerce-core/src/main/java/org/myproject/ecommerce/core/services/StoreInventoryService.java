...
public class StoreInventoryService {
                    ...
                    product20034Variations.stream()
                                          .map(p -> {
                                                  if("sku1".equals(p.getSku())) {
                                                      return new StoreInventory.StoreVariation("sku1", 5);
                                                  } else if("sku2".equals(p.getSku())) {
                                                      return new StoreInventory.StoreVariation("sku2", 23);
                                                  } else if("sku3".equals(p.getSku())) {
                                                      return new StoreInventory.StoreVariation("sku3", 2);
                                                  } else {
                                                      return new StoreInventory.StoreVariation(p.getSku(), 1);
                                                  }
                                                })
                                          .collect(toList());
    ...
    public Optional<StoreInventory.StoreVariation> getStoreInventoryVariation(String storeId, String productId, String sku) {
